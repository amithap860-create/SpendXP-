              ...
              <div className="flex flex-col gap-4">
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    />
                    <Button onClick={handleAddSavings} className="h-12 px-6 rounded-xl font-bold gap-2" suppressHydrationWarning>
              ...
              <CardContent className="space-y-4">
                <div className="flex gap-2">
                  <Input 
                    ...
                    suppressHydrationWarning
                  />
                  <Button onClick={handleUpdateGoal} variant="outline" className="h-12" suppressHydrationWarning>Update Goal</Button>
                </div>
                <div className="grid grid-cols-2 gap-4 mt-4">
                  {[
                    { label: 'Video Game', amount: 5000 },
                    { label: 'New Shoes', amount: 8000 },
                    { label: 'Tablet', amount: 35000 },
                    { label: 'College Fund', amount: 500000 }
                  ].map(preset => (
                    <Button 
                      key={preset.label} 
                      variant="ghost" 
                    ...
                    >
                      ...
                      <span className="text-lg font-bold">{formatValue(preset.amount)}</span>
                    </Button>
                  ))}
                </div>
              </CardContent>
